...
```
After processing all photos, in base project directory will appear <b>'results_{folder}'</b> folder with __"YES"__ and __"NO"__ subdirectories, where all proceeded pictures were recorded.
